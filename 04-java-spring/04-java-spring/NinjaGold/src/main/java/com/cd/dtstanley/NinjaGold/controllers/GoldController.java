package com.cd.dtstanley.NinjaGold.controllers;
...
//	}
	...
	public String goldProcessing(HttpSession session, @RequestParam("building")String building) {
		System.out.println("Which building activity: " + building);
		Random r = new Random();
		LocalDateTime now = LocalDateTime.now();
		DateTimeFormatter formatter = DateTimeFormatter.ofPattern("MMMM dd YYYY h:nma");
//		System.out.println(now);
		...
		session.setAttribute("activity", activity);
		System.out.println("This is the " + activity);
		return "redirect:/";
	}
